...
{
    public partial class Miseajourvoiture : Form
    {
        public Miseajourvoiture()
        {
            InitializeComponent();
        }
        Voiture v;
        private void Miseajourvoiture_Load(object sender, EventArgs e)
        {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (radioButton1.Checked)
                {
                    ...
                    str = "Update Voiture set Matricule = '" + v.MATRICULE + "', Annee = '" + v.DATE + "', Num_M = '" + v.NMarque + "', N_M = '" + v.NModele + "', Etats = '" + v.ETAT + "' where Matricule = '" + v.MATRICULE + "'";
                }
